...
latex_documents = [
    (master_doc, 'AdafruitCircuitPlaygroundLibrary.tex', u'Adafruit CircuitPlayground Library Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'adafruitCircuitPlaygroundlibrary', u'Adafruit CircuitPlayground Library Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AdafruitCircuitPlaygroundLibrary', u'Adafruit CircuitPlayground Library Documentation',
     author, 'AdafruitCircuitPlaygroundLibrary', 'One line description of project.',
     'Miscellaneous'),
]
